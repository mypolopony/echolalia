    ...
    def parse_chat_log(self, bucket: str, chat_log_filename: str) -> pd.DataFrame:
        ...
        for line in chat_log.splitlines():
            ...
            try:
                ...
                payload["timestamp"] = current_timestamp = timestampimport re
from dateutil import parser
from datetime import datetime
import pandas as pd
from ._utils import get_matching_s3_objects, read_s3_file
...
class iMessageParser(GenericParser):
    ...
    def parse_chat_log(self, bucket: str, chat_log_filename: str) -> pd.DataFrame:
        ...
        # For line in chat log, if the timestamp is found, create a new message object based on the remaining content (while not a new line)
        ...
        for line in chat_log.splitlines():
            ...
            if match:
                ...
                timestamp_dt = datetime.strptime(timestamp_str, "%b %d, %Y %I:%M:%S %p")
            else:
